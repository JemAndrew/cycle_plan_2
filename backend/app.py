...
def get_all_users():
    try:
        ...
        users_collection = db['users']  # <- Make sure your MongoDB collection is called 'users'
        
        # Find all users and project only the 'username' field
...
def on_join(data):
    ...
    join_room(username)
    print(f"User {username} has joined their private room.")
